				...
				<div class="row justify-content-md-center">
            		<div class="col-md-auto">
						<form name="formulario" style="float:center" method="POST" action="pesquisa.php">
								<input class="form-control mr-sm-2" style="min-width: 345px; text-align: center" type="text" name="nome_projeto" placeholder="Nome do projeto"> <br>
								<input class="form-control mr-sm-2" style="min-width: 345px; text-align: center" type="text" name="nome_produto" placeholder="Nome do produto"> <br>
								<input class="form-control mr-sm-2" style="min-width: 345px; text-align: center" type="text" name="nome_empresa" placeholder="Nome da empresa"> <br>
								<?php
								if($_SESSION['tipo'] == 1) // Usuário comum não pode ver propostas de outros prospectadores
								{
									echo "<input class='form-control mr-sm-2' style='min-width: 345px; text-align: center'  type='text' name='nome_usuario' placeholder='Nome do prospectador'> <br>";
								}
								?>
